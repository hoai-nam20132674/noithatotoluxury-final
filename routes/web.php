...
Route::get('search',['as'=>'searchText','uses'=>'AuthClient\ClientController@searchText']);
...
Route::get('plus-view-blog/{url}',['as'=>'plusViewBlog','uses'=>'AuthClient\ClientController@plusViewBlog']);
...
Route::group(['prefix'=>'auth/admin','middleware'=>'auth'], function(){
	...
	Route::get('update-order/{id}-{value}',['as'=>'updateOrder','uses'=>'Auth\AdminController@updateOrder']);
