								...
								@if($us->id == Auth::user()->id)
									<tr>
										...
										<td class="text-center">
											<a style="pointer-events: none;cursor: default;" onclick="return confirmDelete('Bạn có chắc muốn xóa dịch vụ này không')" title="Xóa thành viên"><i class="fa fa-trash-o" style="width: 20%; font-size: 18px; color: red; margin-right: 5px;"></i></a>
											<a style="pointer-events: none;" href="{{ URL::route('editUser',$us->id)}}" title="Sửa thông tin tài khoản"><i class="fa fa-pencil-square-o" style="width: 20%; font-size: 18px;"></i></a>
										</td>
									</tr>
								@else
									<tr>
										...
										<td>{{$us->email}}</td>
										<td class="text-center">
											<a style="pointer-events: none;" onclick="return confirmDelete('Bạn có chắc muốn xóa tài khoản này không')" title="Xóa thành viên"><i class="fa fa-trash-o" style="width: 20%; font-size: 18px; color: red; margin-right: 5px;"></i></a>
											<a style="pointer-events: none;" href="{{ URL::route('editUser',$us->id)}}" title="Sửa thông tin tài khoản"><i class="fa fa-pencil-square-o" style="width: 20%; font-size: 18px;"></i></a>
										</td>
									</tr>
								@endif
							...
							@foreach($users as $us)
								@if($us->id == Auth::user()->id)
									<tr>
										...
										<td>{{$us->email}}</td>
										<td class="text-center">
											<a style="pointer-events: none;cursor: default;" onclick="return confirmDelete('Bạn có chắc muốn xóa tài khoản này không')" title="Xóa thành viên"><i class="fa fa-trash-o" style="width: 20%; font-size: 18px; color: red; margin-right: 5px;"></i></a>
											<a style="pointer-events: none;" href="{{ URL::route('editUser',$us->id)}}" title="Sửa thông tin tài khoản"><i class="fa fa-pencil-square-o" style="width: 20%; font-size: 18px;"></i></a>
										</td>
									</tr>
								@else
									<tr>
										...
										<td class="text-center">
											<a style="pointer-events: none;cursor: default;" onclick="return confirmDelete('Bạn có chắc muốn xóa tài khoản này không')" title="Xóa thành viên"><i class="fa fa-trash-o" style="width: 20%; font-size: 18px; color: red; margin-right: 5px;"></i></a>
											<a style="pointer-events: none;cursor: default;" href="{{ URL::route('editUser',$us->id)}}" title="Sửa thành viên"><i class="fa fa-pencil-square-o" style="width: 20%; font-size: 18px;"></i></a>
										</td>
									</tr>
								@endif
							@endforeach
