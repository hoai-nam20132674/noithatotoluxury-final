					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								<a style="pointer-events: none;" onclick="return confirmDelete('Bạn có chắc muốn xóa tin tức này không')" href="{{ URL::route('deleteBlog',$blog->id)}}" title="Xóa danh mục"><i class="fa fa-trash-o" style="width: 20%; font-size: 18px; color: red; margin-right: 5px;"></i></a>
								<a href="{{ URL::route('editBlog',$blog->id)}}" title="Sửa danh mục"><i class="fa fa-pencil-square-o" style="width: 20%; font-size: 18px;"></i></a>
							</td>
						</tr>
						@endforeach
					</tbody>
