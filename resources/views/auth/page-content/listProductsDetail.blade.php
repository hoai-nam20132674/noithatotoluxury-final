						...
						@foreach($products_detail as $pr)
							...
							<tr>
								...
								<td class="text-center">
									<a style="pointer-events: none;" onclick="return confirmDelete('Bạn có chắc muốn xóa sản phẩm chi tiết này không')" href="{{URL::route('deleteProductDetail',$pr->id)}}" title="Xóa sản phẩm chi tiết"><i class="fa fa-trash-o" style="width: 20%; font-size: 18px; color: red; margin-right: 5px;"></i></a>
									<a href="{{URL::route('editProductDetail',$pr->id)}}" title="Sửa sản phẩm chi tiết"><i class="fa fa-pencil-square-o" style="width: 20%; font-size: 18px;"></i></a>
									<a href="{{ URL::route('historyEditProductDetail',$pr->id)}}" title="Lịch sử chỉnh sửa sản phẩm chi tiết"><i class="fa fa-history" style="width: 20%; font-size: 18px;"></i></a>
								</td>
