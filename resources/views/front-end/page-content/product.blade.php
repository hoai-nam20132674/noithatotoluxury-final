...
@section('content')
  ...
  <div class="social-icons share-icons share-row relative icon-style-outline " >
    ...
    <a href="//www.facebook.com/sharer.php?u={{$system->website}}/{{$products->url}}" data-label="Facebook" onclick="window.open(this.href,this.title,'width=500,height=500,top=300px,left=300px');  return false;" rel="noopener noreferrer nofollow" target="_blank" class="icon button circle is-outline tooltip facebook" title="Share on Facebook"><i class="icon-facebook" ></i></a>
    <a href="//twitter.com/share?url={{$system->website}}/{{$products->url}}" onclick="window.open(this.href,this.title,'width=500,height=500,top=300px,left=300px');  return false;" rel="noopener noreferrer nofollow" target="_blank" class="icon button circle is-outline tooltip twitter" title="Share on Twitter"><i class="icon-twitter" ></i></a>
    <a href="mailto:enteryour@addresshere.com?subject=B%E1%BB%99%205%20d%C3%A2y%20t%E1%BA%ADp%20th%E1%BB%83%20d%E1%BB%A5c%20%C4%91%C3%A0n%20h%E1%BB%93i%20ch%C3%ADnh%20h%C3%A3ng%20MDBuddy%20MD1366&amp;body=Check%20this%20out:%20{{$system->website}}/{{$products->url}}" rel="nofollow" class="icon button circle is-outline tooltip email" title="Email to a Friend"><i class="icon-envelop" ></i></a>
    <a href="//pinterest.com/pin/create/button/?url={{$system->website}}/{{$products->url}}&amp;media={{$system->url}}/public/uploads/systems/share_image/{{$system->share_image}}&amp;description=B%E1%BB%99%205%20d%C3%A2y%20t%E1%BA%ADp%20th%E1%BB%83%20d%E1%BB%A5c%20%C4%91%C3%A0n%20h%E1%BB%93i%20ch%C3%ADnh%20h%C3%A3ng%20MDBuddy%20MD1366" onclick="window.open(this.href,this.title,'width=500,height=500,top=300px,left=300px');  return false;" rel="noopener noreferrer nofollow" target="_blank" class="icon button circle is-outline tooltip pinterest" title="Pin on Pinterest"><i class="icon-pinterest" ></i></a>
    <a href="//plus.google.com/share?url={{$system->website}}/{{$products->url}}" target="_blank" class="icon button circle is-outline tooltip google-plus" onclick="window.open(this.href,this.title,'width=500,height=500,top=300px,left=300px');  return false;" rel="noopener noreferrer nofollow" title="Share on Google+"><i class="icon-google-plus" ></i></a>
    <a href="//www.linkedin.com/shareArticle?mini=true&url={{$system->website}}/{{$products->url}}/&title=B%E1%BB%99%205%20d%C3%A2y%20t%E1%BA%ADp%20th%E1%BB%83%20d%E1%BB%A5c%20%C4%91%C3%A0n%20h%E1%BB%93i%20ch%C3%ADnh%20h%C3%A3ng%20MDBuddy%20MD1366" onclick="window.open(this.href,this.title,'width=500,height=500,top=300px,left=300px');  return false;"  rel="noopener noreferrer nofollow" target="_blank" class="icon button circle is-outline tooltip linkedin" title="Share on LinkedIn"><i class="icon-linkedin" ></i></a></div>
  		</div><!-- .summary -->
